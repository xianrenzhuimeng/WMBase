...
@property (nonatomic ,strong) NSMutableArray *classVMAry; ///记录当前类绑定的VM 数
...
- (void)ucm_confignetworkforname:(NSString *)networkname
    ...
    [self toolIn_confignetworksingleapi:api classVM:vmClass];
...
/// tool——配置单个带缓存机制的网络请求
- (void)toolIn_confignetworksingleapi:(UCMHttpRequest *)api classVM:(Class)classStr{
